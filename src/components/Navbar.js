...
const activeIitem = location.pathname === '/hero' ? 'Home' :
                   location.pathname === '/work' ? 'Projects' :
                   location.pathname === '/galle' ? 'Gallery' :
  ...
  return (
    <div className="relative z-10 text-gray-500 flex justify-between items-center max-w-[1240px] mx-auto h-24 px-4 text-l">
      ...
      <li className={`p-5 cursor-pointer ${ activeIitem === 'Home' ? 'text-violet-500' : ''}`} onClick={() => handleItemClick('Home', '/hero')}>Home</li>
        <li className={`p-5 cursor-pointer ${activeIitem === 'Skills' ? 'text-violet-500' : ''}`} // Add active class
                    onClick={() => handleItemClick('Skills', '/skills')}>Skills</li>
        <li className={`p-5 cursor-pointer ${activeIitem === 'Projects' ? 'text-violet-500' : ''}`} // Add active class
                    onClick={() => handleItemClick('Projects', '/work')}>Projects</li>
        <li className={`p-5 cursor-pointer ${activeIitem === 'Gallery' ? 'text-violet-500' : ''}`} // Add active class
                    onClick={() => handleItemClick('Gallery', '/galle')}>Gallery</li>
