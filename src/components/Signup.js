    ...
    <div style={{ backgroundImage: `url(${bgimage})`, backgroundSize: "cover", minHeight: "100vh" }}>
      ...
      >
        <div className="flex justify-center items-center h-screen ">
          <div className="absolute bg-neutral-700 px-10 py-10 rounded-xl border-1 ring-1 ring-black ring-opacity-5 border-gray-100 border  ">
            <div className="flex items-center gap-2 pb-3 justify-center">
              <HiOutlineUser className="text-violet-500" fontSize={25} />
            ...
            <div className="mt-8">
              <div className="flex gap-x-4">
                <div className="flex flex-col">
                  <label
                    htmlFor="firstName"
                    className="block text-gray-200 text-base"
                  >
                    First Name
                  </label>
                  <input
            ...
            <label
              htmlFor="address"
              className="block text-gray-200 text-base mt-1"
            >
              Address
            </label>
            <input
            ...
            <div className="flex">
              <div className="flex flex-col mr-4">
                <label htmlFor="email" className="text-gray-200 text-base mt-1">
                  Email
                </label>
                <input
                  id="email"
            ...
            <div className="flex justify-center">
              <div className="flex flex-col mr-4">
                <label htmlFor="gender" className="text-gray-200 text-base mt-1">
                  Gender
                </label>
                <select
                  className={`w-full border-2 text-sm border-gray-300 round-xl p-2 mt-1 bg-white text-black ${
            ...
            <div className="flex flex-row px-2 py-6">
              <p className="text-sm">Already have an Account? &nbsp;</p> <Link className="text-sm text-violet-500 hover:no-underline"to="/">Login</Link>
            </div>
          </div>
        </div>
      </form>
